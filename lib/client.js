...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const btnPrimary = { padding: '3px 12px', borderRadius: '6px', border: 'none', cursor: 'pointer', fontSize: '12px', background: V.primary, color: V.primaryText }
