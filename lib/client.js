...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // ---- 主题 token（带 fallback，对齐 heartbeat/memory；变量缺失时落到可读色值，避免全白/突兀） ----
    const V = {
      primary: 'var(--dsw-alias-brand-primary, #4c8bf5)',
      border: 'var(--dsw-alias-border-l1, rgba(128,128,128,0.2))',
      overlay: 'var(--dsw-alias-bg-overlay, #1e1e1e)',
      surface: 'var(--dsw-alias-bg-layer-1, #232328)',
      surface2: 'var(--dsw-alias-bg-base, #1b1b1f)',
      text: 'var(--dsw-alias-label-primary, #e6e6e6)',
      text2: 'var(--dsw-alias-label-secondary, #9a9aa3)',
