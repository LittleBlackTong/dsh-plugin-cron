/**
 * dsh-plugin-cron — scheduled agent tasks for DeepSeek Harness.
 *
...
export function apply(ctx, config = {}) {
  ...
  const disposeTool = registerTool(ctx, store)
  ...
  ctx.inject(['webServer'], (webCtx) => {
    const disposeRoutes = registerRoutes(webCtx, store)
